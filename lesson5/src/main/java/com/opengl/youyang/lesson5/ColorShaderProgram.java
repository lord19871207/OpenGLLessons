...
public class ColorShaderProgram extends ShaderProgram{
    ...
    super(context,R.raw.point_vertext_shader,R.raw.point_fragment_shader);
        ...
        aTextureCoordLocation=GLES20.glGetAttribLocation(mProgram,A_TEXTURECOORD);
    }
...
//        GLES20.glUniform4f(u_ColorLocation,r,g,b,1f);
        GLES20.glUniform1i(u_ColorLocation, 0);
     ...
     * @return
     */
    public int getTextureCoordAttributionLocation(){
